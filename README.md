...
| `recreate_release` | String | When to recreate the release instead of updating it (will update the time and put it above other releases). Valid values : never|commit|always. Default value is 'never'                                                                                                                                                                                                                                                                             |
